...
require (
	...
	github.com/DataDog/datadog-agent/pkg/quantile v0.43.0-rc.5
	github.com/DataDog/datadog-agent/pkg/trace v0.43.0-rc.5
...
require (
	...
	github.com/DataDog/datadog-agent/pkg/obfuscate v0.43.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/pkg/remoteconfig/state v0.43.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/pkg/util/cgroups v0.43.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/pkg/util/log v0.43.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/pkg/util/pointer v0.43.0-rc.5 // indirect
