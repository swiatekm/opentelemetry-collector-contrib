...
require (
	...
	github.com/DataDog/datadog-agent/pkg/quantile v0.41.0-rc.4
	github.com/DataDog/datadog-agent/pkg/trace v0.41.0-rc.4
...
require (
	...
	github.com/DataDog/datadog-agent/pkg/obfuscate v0.41.0-rc.4 // indirect
	github.com/DataDog/datadog-agent/pkg/remoteconfig/state v0.41.0-rc.4 // indirect
	github.com/DataDog/datadog-agent/pkg/util/cgroups v0.41.0-rc.4 // indirect
	github.com/DataDog/datadog-agent/pkg/util/log v0.41.0-rc.4 // indirect
