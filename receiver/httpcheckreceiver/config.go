...
// (which disables HTTP keep-alives under the current confighttp defaults).
func (cfg *targetConfig) Unmarshal(componentParser *confmap.Conf) error {
	...
	return componentParser.Unmarshal((*rawTargetConfig)(cfg))
}
